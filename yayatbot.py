...
os.system('clear')  # Membersihkan layar untuk tampilan yang lebih rapi
os.system('figlet YAYATBOT | lolcat -a -d 3')  # Menambahkan lolcat untuk animasi pelangi
...
def yayat_suara(teks):
    ...
    try:
        ...
        print(f"Yayat: Gagal memanggil termux-tts-speak. Error: {e}")
...
def yayat_popup(teks):
    ...
    try:
        ...
        print(f"Yayat: Gagal memanggil termux-toast. Error: {e}")
